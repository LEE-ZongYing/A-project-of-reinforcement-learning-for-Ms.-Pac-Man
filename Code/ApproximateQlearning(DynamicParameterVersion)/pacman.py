...
#        GameState.explored.add(self)
    ...
    def generateSuccessor(self, agentIndex, action):
        ...
        """
        #print('Pacman.py_agentIndex:', agentIndex, 'action:', action)
...
class GhostRules:
    ...
    def getLegalActions(state, ghostIndex):
        ...
        ##print('Ghost_possibleActions:', possibleActions)
        #print('Ghost_reverse:', reverse)
...
def readCommand(argv):
    ...
    GhostagentOpts = parseAgentArgs(options.agentArgs)
    if options.numTraining > 0:
        args['numTraining'] = options.numTraining
        if 'numTraining' not in GhostagentOpts:
            GhostagentOpts['numTraining'] = options.numTraining
    ghost = ghostType(**GhostagentOpts)
    args['ghosts'] = ghost
...
if __name__ == '__main__':
    ...
    runGames(**args,alpha=0.6,gamma=0.4,epsilon=0.6)
